...
def test_temporal_metadata(trovis: Trovis557x) -> None:
    ...
    disinfection_start = trovis.rk4.require_metadata_for("disinfection_start")
...
async def test_recurring_date_and_disinfection_writes(
    ...
    await trovis.rk4.set_disinfection_start(time(20, 15))
    await trovis.rk4.set_disinfection_stop(time(22, 0))
