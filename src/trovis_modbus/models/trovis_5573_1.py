"""Static physical-input definition for the TROVIS 5573-1."""
...
# EB 5573-1, firmware 3.10.xx, figures 4 and 5. The sensor and input hardware
# matches the documented TROVIS 5573 matrix. The separate model definition is
# retained because register 40002 is assumed to report raw model value 55731.
